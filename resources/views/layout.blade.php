...
<div class="d-flex flex-column flex-md-row align-items-baseline pb-3 mb-4 bg-dark border-bottom">
    <a href="/" class="d-flex align-items-baseline text-white text-decoration-none">
        ...
        <span class="fs-4">Отзывы обо всем</span>
    </a>
